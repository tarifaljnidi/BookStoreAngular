...
export class BookService {
  ...
  private baseUrl = "https://bookstorebackendserver.herokuapp.com/api/v1/books";
  private categoryUrl = "https://bookstorebackendserver.herokuapp.com/api/v1/book-category";
